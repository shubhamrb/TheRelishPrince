...
public class BurgerFragment extends Fragment {
    ...
    private RecyclerView burgersList;

    private RecyclerView.LayoutManager layoutManager;

    private DatabaseReference BurgersReference;
    private View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView= inflater.inflate(R.layout.fragment_burger, container, false);

        burgersList=(RecyclerView)mView.findViewById(R.id.burgers_list);

        BurgersReference= FirebaseDatabase.getInstance().getReference().child("burger");
        ...
        burgersList.setLayoutManager(linearLayoutManager);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<Category> options = new FirebaseRecyclerOptions.Builder<Category>()
                .setQuery(BurgersReference,Category.class)
                .build();
        ...
        burgersList.setAdapter(firebaseRecyclerAdapter);
