 ...
 */
public class ParathaCutlets extends Fragment {

    private RecyclerView parathaCutletsList;

    private RecyclerView.LayoutManager layoutManager;

    private DatabaseReference ParathaCutletsReference;
    private View mView;



    public ParathaCutlets() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView= inflater.inflate(R.layout.fragment_paratha_cutlets, container, false);

        parathaCutletsList=(RecyclerView)mView.findViewById(R.id.parathaCutlets_list);

        ParathaCutletsReference= FirebaseDatabase.getInstance().getReference().child("cutlets");


        parathaCutletsList.setHasFixedSize(true);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getContext());
        linearLayoutManager.setReverseLayout(true);
        linearLayoutManager.setStackFromEnd(true);
        parathaCutletsList.setLayoutManager(linearLayoutManager);
    ...
    public void onStart() {
        ...
        if (Common.isConnectedToInternet(getActivity()))
        {
            ...
            FirebaseRecyclerOptions<Category> options = new FirebaseRecyclerOptions.Builder<Category>()
                    .setQuery(ParathaCutletsReference, Category.class)
                    .build();
            ...
            parathaCutletsList.setAdapter(firebaseRecyclerAdapter);
